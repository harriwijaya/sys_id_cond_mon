...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1879333316U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4159302506U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1641170433U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3285796756U);
}
...
mxArray *sf_c4_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("e5ZZYQVAwMvgTkG5TONaJB");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,280,297,367,535);
...
static void mdlSetWorkWidths_c4_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3793447570U));
  ssSetChecksum1(S,(1604478605U));
  ssSetChecksum2(S,(493488241U));
  ssSetChecksum3(S,(716604885U));
