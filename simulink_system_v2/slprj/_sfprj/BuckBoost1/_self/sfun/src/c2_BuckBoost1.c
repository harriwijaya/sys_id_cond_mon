...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1571302610U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1211777948U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4009947966U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1821756377U);
}
...
mxArray *sf_c2_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("7CcOjQVX54DukzJpsCqNRG");
...
static void mdlSetWorkWidths_c2_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1642780136U));
  ssSetChecksum1(S,(3572420840U));
  ssSetChecksum2(S,(2310053431U));
  ssSetChecksum3(S,(2117354220U));
