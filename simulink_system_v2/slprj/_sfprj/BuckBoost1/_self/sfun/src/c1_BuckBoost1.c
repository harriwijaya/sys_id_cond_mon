...
static const char * c1_debug_family_names[89] = { "sampling_time", "offset",
  "OFFSET_ON_START_abs", "OFFSET_ON_END_rel", "OFFSET_OFF_START_rel",
  "OFFSET_OFF_END_abs", "lambda", "delta", "u", "w", "P", "wi", "Pi", "uu", "wu",
  "Pu", "noiseAmp", "k", "ku", "a", "b", "c", "nargin", "nargout", "start", "t",
  "duty", "v_out", "i_in", "w0in", "w1in", "P11in", "P12in", "P21in", "P22in",
  "Capin", "wi0in", "wi1in", "Pi11in", "Pi12in", "Pi21in", "Pi22in", "wu0in",
  "wu1in", "wu2in", "Pu11in", "Pu12in", "Pu13in", "Pu21in", "Pu22in", "Pu23in",
  "Pu31in", "Pu32in", "Pu33in", "ESRin", "t0in", "y", "e", "w0", "w1", "P11",
  "P12", "P21", "P22", "Capout", "yi", "ei", "wi0", "wi1", "Pi11", "Pi12",
  "Pi21", "Pi22", "yu", "eu", "wu0", "wu1", "wu2", "Pu11", "Pu12", "Pu13",
  "Pu21", "Pu22", "Pu23", "Pu31", "Pu32", "Pu33", "ESRout", "t0" };
...
static real_T c1_emlrt_marshallIn(SFc1_BuckBoost1InstanceStruct *chartInstance,
  const mxArray *c1_t0, const char_T *c1_identifier);
...
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[69]);
  ...
  chartInstance)
{
  ...
  uint32_T c1_ib_hoistedGlobal;
  uint32_T c1_ib_u;
  const mxArray *c1_jb_y = NULL;
  uint32_T c1_jb_hoistedGlobal;
  uint32_T c1_jb_u;
  const mxArray *c1_kb_y = NULL;
  int32_T c1_i0;
  uint32_T c1_kb_u[625];
  ...
  real_T *c1_yi;
  real_T *c1_yu;
  c1_t0 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 33);
  ...
  c1_ob_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_createcellarray(38), FALSE);
  ...
  c1_ib_hoistedGlobal = chartInstance->c1_method;
  c1_ib_u = c1_ib_hoistedGlobal;
  c1_jb_y = NULL;
  if (!chartInstance->c1_method_not_empty) {
    sf_mex_assign(&c1_jb_y, sf_mex_create("y", NULL, 0, 0U, 1U, 0U, 2, 0, 0),
                  FALSE);
  } else {
    sf_mex_assign(&c1_jb_y, sf_mex_create("y", &c1_ib_u, 7, 0U, 0U, 0U, 0),
                  FALSE);
  }

  sf_mex_setcell(c1_y, 33, c1_jb_y);
  c1_jb_hoistedGlobal = chartInstance->c1_state;
  c1_jb_u = c1_jb_hoistedGlobal;
  c1_kb_y = NULL;
  if (!chartInstance->c1_state_not_empty) {
    sf_mex_assign(&c1_kb_y, sf_mex_create("y", NULL, 0, 0U, 1U, 0U, 2, 0, 0),
                  FALSE);
  } else {
    sf_mex_assign(&c1_kb_y, sf_mex_create("y", &c1_jb_u, 7, 0U, 0U, 0U, 0),
                  FALSE);
  }

  sf_mex_setcell(c1_y, 34, c1_kb_y);
  for (c1_i0 = 0; c1_i0 < 625; c1_i0++) {
    c1_kb_u[c1_i0] = chartInstance->c1_c_state[c1_i0];
  }

  c1_lb_y = NULL;
  if (!chartInstance->c1_c_state_not_empty) {
    sf_mex_assign(&c1_lb_y, sf_mex_create("y", NULL, 0, 0U, 1U, 0U, 2, 0, 0),
                  FALSE);
  } else {
    sf_mex_assign(&c1_lb_y, sf_mex_create("y", c1_kb_u, 7, 0U, 1U, 0U, 1, 625),
                  FALSE);
  }

  sf_mex_setcell(c1_y, 35, c1_lb_y);
  for (c1_i1 = 0; c1_i1 < 2; c1_i1++) {
    c1_lb_u[c1_i1] = chartInstance->c1_b_state[c1_i1];
  }

  c1_mb_y = NULL;
  if (!chartInstance->c1_b_state_not_empty) {
    sf_mex_assign(&c1_mb_y, sf_mex_create("y", NULL, 0, 0U, 1U, 0U, 2, 0, 0),
                  FALSE);
  } else {
    sf_mex_assign(&c1_mb_y, sf_mex_create("y", c1_lb_u, 7, 0U, 1U, 0U, 1, 2),
                  FALSE);
  }

  sf_mex_setcell(c1_y, 36, c1_mb_y);
  c1_kb_hoistedGlobal = chartInstance->c1_is_active_c1_BuckBoost1;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_ESRout = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    1)), "ESRout");
  *c1_P11 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
    "P11");
  *c1_P12 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
    "P12");
  *c1_P21 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
    "P21");
  *c1_P22 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 5)),
    "P22");
  ...
  *c1_Pu33 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    18)), "Pu33");
  *c1_e = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 19)),
    "e");
  *c1_ei = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 20)),
    "ei");
  *c1_eu = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 21)),
    "eu");
  *c1_t0 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 22)),
    "t0");
  *c1_w0 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 23)),
    "w0");
  *c1_w1 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 24)),
    "w1");
  ...
  *c1_wu2 = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    29)), "wu2");
  *c1_y = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 30)),
    "y");
  *c1_yi = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 31)),
    "yi");
  *c1_yu = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 32)),
    "yu");
  chartInstance->c1_method = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c1_u, 33)), "method");
  chartInstance->c1_state = c1_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c1_u, 34)), "state");
  c1_l_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 35)),
                        "state", c1_uv0);
  for (c1_i2 = 0; c1_i2 < 625; c1_i2++) {
    chartInstance->c1_c_state[c1_i2] = c1_uv0[c1_i2];
  }

  c1_n_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 36)),
                        "state", c1_uv1);
...
static void sf_c1_BuckBoost1(SFc1_BuckBoost1InstanceStruct *chartInstance)
{
  ...
  c1_ei = (real_T *)ssGetOutputPortSignal(chartInstance->S, 11);
  c1_yi = (real_T *)ssGetOutputPortSignal(chartInstance->S, 10);
  c1_t0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 31);
  c1_ESRin = (real_T *)ssGetInputPortSignal(chartInstance->S, 30);
  c1_Pu33in = (real_T *)ssGetInputPortSignal(chartInstance->S, 29);
  c1_Pu32in = (real_T *)ssGetInputPortSignal(chartInstance->S, 28);
  c1_Pu31in = (real_T *)ssGetInputPortSignal(chartInstance->S, 27);
  c1_Pu23in = (real_T *)ssGetInputPortSignal(chartInstance->S, 26);
  c1_Pu22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 25);
  c1_Pu21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 24);
  c1_Pu13in = (real_T *)ssGetInputPortSignal(chartInstance->S, 23);
  c1_Pu12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 22);
  c1_Pu11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 21);
  c1_wu2in = (real_T *)ssGetInputPortSignal(chartInstance->S, 20);
  c1_wu1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 19);
  c1_wu0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 18);
  c1_Pi22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 17);
  c1_Pi21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 16);
  c1_Pi12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 15);
  c1_Pi11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 14);
  c1_wi1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c1_wi0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 12);
  c1_Capout = (real_T *)ssGetOutputPortSignal(chartInstance->S, 9);
  c1_P22 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 8);
  c1_P21 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 7);
  c1_P12 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 6);
  ...
  c1_e = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_Capin = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_P22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_P21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_P12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 8);
  c1_P11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_w1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_w0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  ...
  _SFD_DATA_RANGE_CHECK(*c1_v_out, 3U);
  _SFD_DATA_RANGE_CHECK(*c1_i_in, 4U);
  _SFD_DATA_RANGE_CHECK(*c1_w0in, 5U);
  _SFD_DATA_RANGE_CHECK(*c1_w1in, 6U);
  _SFD_DATA_RANGE_CHECK(*c1_P11in, 7U);
  _SFD_DATA_RANGE_CHECK(*c1_P12in, 8U);
  _SFD_DATA_RANGE_CHECK(*c1_P21in, 9U);
  _SFD_DATA_RANGE_CHECK(*c1_P22in, 10U);
  _SFD_DATA_RANGE_CHECK(*c1_Capin, 11U);
  _SFD_DATA_RANGE_CHECK(*c1_y, 12U);
  _SFD_DATA_RANGE_CHECK(*c1_e, 13U);
  _SFD_DATA_RANGE_CHECK(*c1_w0, 14U);
  _SFD_DATA_RANGE_CHECK(*c1_w1, 15U);
  _SFD_DATA_RANGE_CHECK(*c1_P11, 16U);
  _SFD_DATA_RANGE_CHECK(*c1_P12, 17U);
  _SFD_DATA_RANGE_CHECK(*c1_P21, 18U);
  _SFD_DATA_RANGE_CHECK(*c1_P22, 19U);
  _SFD_DATA_RANGE_CHECK(*c1_Capout, 20U);
  _SFD_DATA_RANGE_CHECK(*c1_wi0in, 21U);
  _SFD_DATA_RANGE_CHECK(*c1_wi1in, 22U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi11in, 23U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi12in, 24U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi21in, 25U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi22in, 26U);
  _SFD_DATA_RANGE_CHECK(*c1_wu0in, 27U);
  _SFD_DATA_RANGE_CHECK(*c1_wu1in, 28U);
  _SFD_DATA_RANGE_CHECK(*c1_wu2in, 29U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu11in, 30U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu12in, 31U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu13in, 32U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu21in, 33U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu22in, 34U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu23in, 35U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu31in, 36U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu32in, 37U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu33in, 38U);
  _SFD_DATA_RANGE_CHECK(*c1_ESRin, 39U);
  _SFD_DATA_RANGE_CHECK(*c1_t0in, 40U);
  _SFD_DATA_RANGE_CHECK(*c1_yi, 41U);
  _SFD_DATA_RANGE_CHECK(*c1_ei, 42U);
  _SFD_DATA_RANGE_CHECK(*c1_wi0, 43U);
  _SFD_DATA_RANGE_CHECK(*c1_wi1, 44U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi11, 45U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi12, 46U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi21, 47U);
  _SFD_DATA_RANGE_CHECK(*c1_Pi22, 48U);
  _SFD_DATA_RANGE_CHECK(*c1_yu, 49U);
  _SFD_DATA_RANGE_CHECK(*c1_eu, 50U);
  _SFD_DATA_RANGE_CHECK(*c1_wu0, 51U);
  _SFD_DATA_RANGE_CHECK(*c1_wu1, 52U);
  _SFD_DATA_RANGE_CHECK(*c1_wu2, 53U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu11, 54U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu12, 55U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu13, 56U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu21, 57U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu22, 58U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu23, 59U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu31, 60U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu32, 61U);
  _SFD_DATA_RANGE_CHECK(*c1_Pu33, 62U);
  _SFD_DATA_RANGE_CHECK(*c1_ESRout, 63U);
  _SFD_DATA_RANGE_CHECK(*c1_t0, 64U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  ...
  *chartInstance)
{
  ...
  real_T c1_ESRin;
  real_T c1_t0in;
  uint32_T c1_debug_family_var_map[89];
  ...
  real_T c1_b;
  real_T c1_c;
  real_T c1_nargin = 32.0;
  real_T c1_nargout = 33.0;
  real_T c1_y;
  real_T c1_e;
  real_T c1_w0;
  real_T c1_w1;
  ...
  c1_b_t0 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 33);
  ...
  c1_b_t0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 31);
  c1_b_ESRin = (real_T *)ssGetInputPortSignal(chartInstance->S, 30);
  c1_b_Pu33in = (real_T *)ssGetInputPortSignal(chartInstance->S, 29);
  c1_b_Pu32in = (real_T *)ssGetInputPortSignal(chartInstance->S, 28);
  c1_b_Pu31in = (real_T *)ssGetInputPortSignal(chartInstance->S, 27);
  c1_b_Pu23in = (real_T *)ssGetInputPortSignal(chartInstance->S, 26);
  c1_b_Pu22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 25);
  c1_b_Pu21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 24);
  c1_b_Pu13in = (real_T *)ssGetInputPortSignal(chartInstance->S, 23);
  c1_b_Pu12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 22);
  c1_b_Pu11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 21);
  c1_b_wu2in = (real_T *)ssGetInputPortSignal(chartInstance->S, 20);
  c1_b_wu1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 19);
  c1_b_wu0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 18);
  c1_b_Pi22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 17);
  c1_b_Pi21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 16);
  c1_b_Pi12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 15);
  c1_b_Pi11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 14);
  c1_b_wi1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c1_b_wi0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 12);
  ...
  c1_hc_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_Capin = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_b_P22in = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_b_P21in = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_b_P12in = (real_T *)ssGetInputPortSignal(chartInstance->S, 8);
  c1_b_P11in = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_b_w1in = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_b_w0in = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  ...
  c1_f_hoistedGlobal = *c1_b_w0in;
  c1_g_hoistedGlobal = *c1_b_w1in;
  c1_h_hoistedGlobal = *c1_b_P11in;
  c1_i_hoistedGlobal = *c1_b_P12in;
  c1_j_hoistedGlobal = *c1_b_P21in;
  c1_k_hoistedGlobal = *c1_b_P22in;
  c1_l_hoistedGlobal = *c1_b_Capin;
  c1_m_hoistedGlobal = *c1_b_wi0in;
  c1_n_hoistedGlobal = *c1_b_wi1in;
  c1_o_hoistedGlobal = *c1_b_Pi11in;
  c1_p_hoistedGlobal = *c1_b_Pi12in;
  c1_q_hoistedGlobal = *c1_b_Pi21in;
  c1_r_hoistedGlobal = *c1_b_Pi22in;
  c1_s_hoistedGlobal = *c1_b_wu0in;
  c1_t_hoistedGlobal = *c1_b_wu1in;
  c1_u_hoistedGlobal = *c1_b_wu2in;
  c1_v_hoistedGlobal = *c1_b_Pu11in;
  c1_w_hoistedGlobal = *c1_b_Pu12in;
  c1_x_hoistedGlobal = *c1_b_Pu13in;
  c1_y_hoistedGlobal = *c1_b_Pu21in;
  c1_ab_hoistedGlobal = *c1_b_Pu22in;
  c1_bb_hoistedGlobal = *c1_b_Pu23in;
  c1_cb_hoistedGlobal = *c1_b_Pu31in;
  c1_db_hoistedGlobal = *c1_b_Pu32in;
  c1_eb_hoistedGlobal = *c1_b_Pu33in;
  c1_fb_hoistedGlobal = *c1_b_ESRin;
  c1_gb_hoistedGlobal = *c1_b_t0in;
  ...
  c1_w0in = c1_f_hoistedGlobal;
  c1_w1in = c1_g_hoistedGlobal;
  c1_P11in = c1_h_hoistedGlobal;
  c1_P12in = c1_i_hoistedGlobal;
  c1_P21in = c1_j_hoistedGlobal;
  c1_P22in = c1_k_hoistedGlobal;
  c1_Capin = c1_l_hoistedGlobal;
  c1_wi0in = c1_m_hoistedGlobal;
  c1_wi1in = c1_n_hoistedGlobal;
  c1_Pi11in = c1_o_hoistedGlobal;
  c1_Pi12in = c1_p_hoistedGlobal;
  c1_Pi21in = c1_q_hoistedGlobal;
  c1_Pi22in = c1_r_hoistedGlobal;
  c1_wu0in = c1_s_hoistedGlobal;
  c1_wu1in = c1_t_hoistedGlobal;
  c1_wu2in = c1_u_hoistedGlobal;
  c1_Pu11in = c1_v_hoistedGlobal;
  c1_Pu12in = c1_w_hoistedGlobal;
  c1_Pu13in = c1_x_hoistedGlobal;
  c1_Pu21in = c1_y_hoistedGlobal;
  c1_Pu22in = c1_ab_hoistedGlobal;
  c1_Pu23in = c1_bb_hoistedGlobal;
  c1_Pu31in = c1_cb_hoistedGlobal;
  c1_Pu32in = c1_db_hoistedGlobal;
  c1_Pu33in = c1_eb_hoistedGlobal;
  c1_ESRin = c1_fb_hoistedGlobal;
  c1_t0in = c1_gb_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 89U, 89U, c1_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c1_delta, 7U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c1_u, 8U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_w, 9U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_P, 10U, c1_e_sf_marshallOut,
    c1_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_wi, 11U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_Pi, 12U, c1_e_sf_marshallOut,
    c1_e_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_uu, 13U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_wu, 14U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_Pu, 15U, c1_d_sf_marshallOut,
    c1_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_noiseAmp, 16U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c1_k, 17U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_ku, 18U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_a, 19U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_b, 20U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_c, 21U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_nargin, 22U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 23U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_start, 24U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_t, 25U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_duty, 26U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_v_out, 27U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_i_in, 28U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_w0in, 29U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_w1in, 30U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_P11in, 31U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_P12in, 32U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_P21in, 33U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_P22in, 34U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Capin, 35U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_wi0in, 36U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_wi1in, 37U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pi11in, 38U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pi12in, 39U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pi21in, 40U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pi22in, 41U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_wu0in, 42U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_wu1in, 43U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_wu2in, 44U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu11in, 45U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu12in, 46U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu13in, 47U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu21in, 48U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu22in, 49U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu23in, 50U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu31in, 51U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu32in, 52U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Pu33in, 53U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_ESRin, 54U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_t0in, 55U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c1_y, 56U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_e, 57U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_w0, 58U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_w1, 59U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_P11, 60U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_P12, 61U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_P21, 62U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_P22, 63U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Capout, 64U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yi, 65U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_ei, 66U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_wi0, 67U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_wi1, 68U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pi11, 69U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pi12, 70U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pi21, 71U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pi22, 72U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_yu, 73U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_eu, 74U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_wu0, 75U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_wu1, 76U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_wu2, 77U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu11, 78U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu12, 79U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu13, 80U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu21, 81U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu22, 82U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu23, 83U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu31, 84U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu32, 85U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_Pu33, 86U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_ESRout, 87U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_t0, 88U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 13);
  c1_sampling_time = 1.0E-5;
  ...
  if (CV_EML_IF(0, 1, 0, c1_start == 1.0)) {
    ...
    if (CV_EML_COND(0, 1, 0, c1_t > c1_OFFSET_ON_START_abs)) {
      if (CV_EML_COND(0, 1, 1, c1_offset < c1_OFFSET_ON_END_rel)) {
        ...
        guard6 = FALSE;
        if (CV_EML_COND(0, 1, 2, c1_t > c1_OFFSET_ON_START_abs)) {
          if (CV_EML_COND(0, 1, 3, c1_t <= c1_OFFSET_ON_START_abs + 2.0)) {
        ...
        if (guard6 == TRUE) {
          ...
          for (c1_i14 = 0; c1_i14 < 2; c1_i14++) {
            ...
            for (c1_i16 = 0; c1_i16 < 2; c1_i16++) {
              c1_d_y[c1_i14] += c1_d_a[c1_i15 + c1_i14] * c1_c_b[c1_i16];
              c1_i15 += 2;
            }
          }

          for (c1_i17 = 0; c1_i17 < 2; c1_i17++) {
            c1_e_a[c1_i17] = c1_u[c1_i17];
          }

          for (c1_i18 = 0; c1_i18 < 4; c1_i18++) {
            c1_d_a[c1_i18] = c1_P[c1_i18];
          }
          ...
          for (c1_i20 = 0; c1_i20 < 2; c1_i20++) {
            ...
            for (c1_i21 = 0; c1_i21 < 2; c1_i21++) {
              c1_e_y[c1_i20] += c1_e_a[c1_i21] * c1_d_a[c1_i21 + c1_i19];
            }
          ...
          for (c1_d_k = 1; c1_d_k < 3; c1_d_k++) {
            c1_e_k = c1_d_k;
            c1_y += c1_e_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
              _SFD_INTEGER_CHECK("", (real_T)c1_e_k), 1, 2, 1, 0) - 1] *
              c1_c_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
              ("", (real_T)c1_e_k), 1, 2, 1, 0) - 1];
          }
          ...
          for (c1_i31 = 0; c1_i31 < 2; c1_i31++) {
            c1_e_a[c1_i31] = c1_u[c1_i31];
          }

          for (c1_i32 = 0; c1_i32 < 2; c1_i32++) {
            c1_i33 = 0;
            for (c1_i34 = 0; c1_i34 < 2; c1_i34++) {
              c1_k_y[c1_i33 + c1_i32] = c1_c_b[c1_i32] * c1_e_a[c1_i34];
              c1_i33 += 2;
            }
          }

          for (c1_i35 = 0; c1_i35 < 4; c1_i35++) {
            c1_d_a[c1_i35] = c1_P[c1_i35];
          }
    ...
    guard4 = FALSE;
    if (CV_EML_COND(0, 1, 4, c1_offset >= c1_OFFSET_ON_END_rel)) {
      if (CV_EML_COND(0, 1, 5, c1_offset <= c1_OFFSET_ON_END_rel + 1.0)) {
    ...
    guard2 = FALSE;
    if (CV_EML_COND(0, 1, 6, c1_offset > c1_OFFSET_OFF_START_rel)) {
      if (CV_EML_COND(0, 1, 7, c1_t < c1_OFFSET_OFF_END_abs)) {
        ...
        if (CV_EML_COND(0, 1, 8, c1_offset > c1_OFFSET_OFF_START_rel)) {
          if (CV_EML_COND(0, 1, 9, c1_offset <= c1_OFFSET_OFF_START_rel + 2.0))
          {
        ...
        if (guard3 == TRUE) {
          ...
          for (c1_i45 = 0; c1_i45 < 2; c1_i45++) {
            ...
            for (c1_i47 = 0; c1_i47 < 2; c1_i47++) {
              c1_d_y[c1_i45] += c1_d_a[c1_i46 + c1_i45] * c1_c_b[c1_i47];
              c1_i46 += 2;
            }
          }

          for (c1_i48 = 0; c1_i48 < 2; c1_i48++) {
            c1_e_a[c1_i48] = c1_u[c1_i48];
          }

          for (c1_i49 = 0; c1_i49 < 4; c1_i49++) {
            c1_d_a[c1_i49] = c1_Pi[c1_i49];
          }
          ...
          for (c1_i51 = 0; c1_i51 < 2; c1_i51++) {
            ...
            for (c1_i52 = 0; c1_i52 < 2; c1_i52++) {
              c1_e_y[c1_i51] += c1_e_a[c1_i52] * c1_d_a[c1_i52 + c1_i50];
            }
          ...
          for (c1_f_k = 1; c1_f_k < 3; c1_f_k++) {
            c1_g_k = c1_f_k;
            c1_q_y += c1_e_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
              _SFD_INTEGER_CHECK("", (real_T)c1_g_k), 1, 2, 1, 0) - 1] *
              c1_c_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
              ("", (real_T)c1_g_k), 1, 2, 1, 0) - 1];
          }
          ...
          for (c1_i62 = 0; c1_i62 < 2; c1_i62++) {
            c1_e_a[c1_i62] = c1_u[c1_i62];
          }

          for (c1_i63 = 0; c1_i63 < 2; c1_i63++) {
            c1_i64 = 0;
            for (c1_i65 = 0; c1_i65 < 2; c1_i65++) {
              c1_k_y[c1_i64 + c1_i63] = c1_c_b[c1_i63] * c1_e_a[c1_i65];
              c1_i64 += 2;
            }
          }

          for (c1_i66 = 0; c1_i66 < 4; c1_i66++) {
            c1_d_a[c1_i66] = c1_Pi[c1_i66];
          }
          ...
          for (c1_i73 = 0; c1_i73 < 4; c1_i73++) {
            c1_Pi[c1_i73] = c1_l_y[c1_i73] / 0.6;
          }
          ...
          for (c1_i76 = 0; c1_i76 < 3; c1_i76++) {
            ...
            for (c1_i78 = 0; c1_i78 < 3; c1_i78++) {
              c1_x_y[c1_i76] += c1_i_a[c1_i77 + c1_i76] * c1_i_b[c1_i78];
              c1_i77 += 3;
            }
          }

          for (c1_i79 = 0; c1_i79 < 3; c1_i79++) {
            c1_j_a[c1_i79] = c1_uu[c1_i79];
          }

          for (c1_i80 = 0; c1_i80 < 9; c1_i80++) {
            c1_i_a[c1_i80] = c1_Pu[c1_i80];
          }
          ...
          for (c1_i82 = 0; c1_i82 < 3; c1_i82++) {
            ...
            for (c1_i83 = 0; c1_i83 < 3; c1_i83++) {
              c1_y_y[c1_i82] += c1_j_a[c1_i83] * c1_i_a[c1_i83 + c1_i81];
            }
          ...
          for (c1_j_k = 1; c1_j_k < 4; c1_j_k++) {
            ...
            c1_ab_y += c1_y_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
              ...
              c1_i_b[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
              ("", (real_T)c1_k_k), 1, 3, 1, 0) - 1];
          }
          ...
          for (c1_i92 = 0; c1_i92 < 3; c1_i92++) {
            c1_i_b[c1_i92] = c1_ku[c1_i92];
          }

          for (c1_i93 = 0; c1_i93 < 3; c1_i93++) {
            c1_j_a[c1_i93] = c1_uu[c1_i93];
          }

          for (c1_i94 = 0; c1_i94 < 3; c1_i94++) {
            c1_i95 = 0;
            for (c1_i96 = 0; c1_i96 < 3; c1_i96++) {
              c1_fb_y[c1_i95 + c1_i94] = c1_i_b[c1_i94] * c1_j_a[c1_i96];
              c1_i95 += 3;
            }
          }

          for (c1_i97 = 0; c1_i97 < 9; c1_i97++) {
            c1_i_a[c1_i97] = c1_Pu[c1_i97];
          }
          ...
          for (c1_i98 = 0; c1_i98 < 3; c1_i98++) {
            ...
            for (c1_i100 = 0; c1_i100 < 3; c1_i100++) {
              c1_gb_y[c1_i99 + c1_i98] = 0.0;
              c1_i101 = 0;
              for (c1_i102 = 0; c1_i102 < 3; c1_i102++) {
                c1_gb_y[c1_i99 + c1_i98] += c1_fb_y[c1_i101 + c1_i98] *
                  c1_i_a[c1_i102 + c1_i99];
                c1_i101 += 3;
              }
          ...
          for (c1_i103 = 0; c1_i103 < 9; c1_i103++) {
            c1_gb_y[c1_i103] = c1_Pu[c1_i103] - c1_gb_y[c1_i103];
          }

          for (c1_i104 = 0; c1_i104 < 9; c1_i104++) {
            c1_Pu[c1_i104] = c1_gb_y[c1_i104] / 0.6;
          }
    ...
    if (CV_EML_COND(0, 1, 10, c1_t >= c1_OFFSET_OFF_END_abs)) {
      if (CV_EML_COND(0, 1, 11, c1_t <= c1_OFFSET_OFF_END_abs + 1.0)) {
        ...
        c1_v_x = c1_u_x;
        c1_yb_y = c1_xb_y;
        c1_ac_y = c1_v_x / c1_yb_y;
        c1_c = (c1_sb_y + c1_vb_y) - c1_ac_y;
        ...
        c1_x_x = c1_w_x;
        c1_cc_y = c1_bc_y;
        c1_dc_y = c1_x_x / c1_cc_y;
        c1_m_A = c1_c;
        c1_y_x = c1_m_A;
        c1_ab_x = c1_y_x;
        c1_ec_y = c1_ab_x / 30.0;
        c1_n_A = c1_dc_y - c1_c;
        c1_k_B = c1_ec_y - c1_wi1;
        c1_bb_x = c1_n_A;
        c1_fc_y = c1_k_B;
        c1_cb_x = c1_bb_x;
        c1_gc_y = c1_fc_y;
        c1_ESRout = c1_cb_x / c1_gc_y;
      } else {
        guard1 = TRUE;
      }
    } else {
  ...
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -196);
  ...
  const mxArray *c1_t0, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_t0), &c1_thisId);
  sf_mex_destroy(&c1_t0);
  return c1_y;
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_BuckBoost1InstanceStruct *chartInstance;
  chartInstance = (SFc1_BuckBoost1InstanceStruct *)chartInstanceVoid;
  c1_t0 = sf_mex_dup(c1_mxArrayInData);
...
const mxArray *sf_c1_BuckBoost1_get_eml_resolved_functions_info(void)
{
  ...
  c1_ResolvedFunctionInfo c1_info[69];
  c1_ResolvedFunctionInfo (*c1_b_info)[69];
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[69])
{
  ...
  c1_info[20].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  ...
  c1_info[24].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[24].fileTimeLo = 1289494492U;
  ...
  c1_info[25].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c1_info[25].fileTimeLo = 1323145378U;
  ...
  c1_info[35].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  c1_info[35].fileTimeLo = 1286797196U;
  ...
  c1_info[38].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c1_info[38].fileTimeLo = 1323145378U;
  ...
  c1_info[39].fileTimeLo = 1286797180U;
  ...
  c1_info[41].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c1_info[41].fileTimeLo = 1286797178U;
  ...
  c1_info[42].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c1_info[42].fileTimeLo = 1323145378U;
  ...
  c1_info[59].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c1_info[59].fileTimeLo = 1326702796U;
  c1_info[59].fileTimeHi = 0U;
  c1_info[59].mFileTimeLo = 0U;
  c1_info[59].mFileTimeHi = 0U;
  c1_info[60].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c1_info[60].name = "eml_eps";
  c1_info[60].dominantType = "char";
  c1_info[60].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_eps.m";
  c1_info[60].fileTimeLo = 1326702796U;
  c1_info[60].fileTimeHi = 0U;
  c1_info[60].mFileTimeLo = 0U;
  c1_info[60].mFileTimeHi = 0U;
  c1_info[61].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_eps.m";
  c1_info[61].name = "eml_float_model";
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4232100178U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1342465507U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2712083137U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2531038969U);
}
...
mxArray *sf_c1_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hsPgV7toBskvEr8UGQfLmH");
...

  {
    ...
    mxArray *mxData = mxCreateStructMatrix(1,33,3,dataFields);
...
static const mxArray *sf_get_sim_state_info_c1_BuckBoost1(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[34],T\"Capout\",},{M[1],M[83],T\"ESRout\",},{M[1],M[35],T\"P11\",},{M[1],M[31],T\"P12\",},{M[1],M[46],T\"P21\",},{M[1],M[47],T\"P22\",},{M[1],M[89],T\"Pi11\",},{M[1],M[90],T\"Pi12\",},{M[1],M[91],T\"Pi21\",},{M[1],M[92],T\"Pi22\",}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[74],T\"Pu11\",},{M[1],M[75],T\"Pu12\",},{M[1],M[76],T\"Pu13\",},{M[1],M[77],T\"Pu21\",},{M[1],M[78],T\"Pu22\",},{M[1],M[79],T\"Pu23\",},{M[1],M[80],T\"Pu31\",},{M[1],M[81],T\"Pu32\",},{M[1],M[82],T\"Pu33\",},{M[1],M[29],T\"e\",}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[66],T\"ei\",},{M[1],M[70],T\"eu\",},{M[1],M[84],T\"t0\",},{M[1],M[44],T\"w0\",},{M[1],M[45],T\"w1\",},{M[1],M[67],T\"wi0\",},{M[1],M[68],T\"wi1\",},{M[1],M[71],T\"wu0\",},{M[1],M[72],T\"wu1\",},{M[1],M[73],T\"wu2\",}}",
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[28],T\"y\",},{M[1],M[65],T\"yi\",},{M[1],M[69],T\"yu\",},{M[4],M[0],T\"method\",S'l','i','p'{{M1x2[512 518],M[1],T\"C:/Program Files/MATLAB/R2012b/toolbox/eml/lib/matlab/randfun/eml_rand.m\"}}},{M[4],M[0],T\"state\",S'l','i','p'{{M1x2[165 170],M[1],T\"C:/Program Files/MATLAB/R2012b/toolbox/eml/lib/matlab/randfun/eml_rand_mcg16807_stateful.m\"}}},{M[4],M[0],T\"state\",S'l','i','p'{{M1x2[166 171],M[1],T\"C:/Program Files/MATLAB/R2012b/toolbox/eml/lib/matlab/randfun/eml_rand_mt19937ar_stateful.m\"}}},{M[4],M[0],T\"state\",S'l','i','p'{{M1x2[165 170],M[1],T\"C:/Program Files/MATLAB/R2012b/toolbox/eml/lib/matlab/randfun/eml_rand_shr3cong_stateful.m\"}}},{M[8],M[0],T\"is_active_c1_BuckBoost1\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(7,1,1,0,"P11in");
          _SFD_SET_DATA_PROPS(8,1,1,0,"P12in");
          _SFD_SET_DATA_PROPS(9,1,1,0,"P21in");
          _SFD_SET_DATA_PROPS(10,1,1,0,"P22in");
          _SFD_SET_DATA_PROPS(11,1,1,0,"Capin");
          _SFD_SET_DATA_PROPS(12,2,0,1,"y");
          _SFD_SET_DATA_PROPS(13,2,0,1,"e");
          _SFD_SET_DATA_PROPS(14,2,0,1,"w0");
          _SFD_SET_DATA_PROPS(15,2,0,1,"w1");
          _SFD_SET_DATA_PROPS(16,2,0,1,"P11");
          _SFD_SET_DATA_PROPS(17,2,0,1,"P12");
          _SFD_SET_DATA_PROPS(18,2,0,1,"P21");
          _SFD_SET_DATA_PROPS(19,2,0,1,"P22");
          _SFD_SET_DATA_PROPS(20,2,0,1,"Capout");
          _SFD_SET_DATA_PROPS(21,1,1,0,"wi0in");
          _SFD_SET_DATA_PROPS(22,1,1,0,"wi1in");
          _SFD_SET_DATA_PROPS(23,1,1,0,"Pi11in");
          _SFD_SET_DATA_PROPS(24,1,1,0,"Pi12in");
          _SFD_SET_DATA_PROPS(25,1,1,0,"Pi21in");
          _SFD_SET_DATA_PROPS(26,1,1,0,"Pi22in");
          _SFD_SET_DATA_PROPS(27,1,1,0,"wu0in");
          _SFD_SET_DATA_PROPS(28,1,1,0,"wu1in");
          _SFD_SET_DATA_PROPS(29,1,1,0,"wu2in");
          _SFD_SET_DATA_PROPS(30,1,1,0,"Pu11in");
          _SFD_SET_DATA_PROPS(31,1,1,0,"Pu12in");
          _SFD_SET_DATA_PROPS(32,1,1,0,"Pu13in");
          _SFD_SET_DATA_PROPS(33,1,1,0,"Pu21in");
          _SFD_SET_DATA_PROPS(34,1,1,0,"Pu22in");
          _SFD_SET_DATA_PROPS(35,1,1,0,"Pu23in");
          _SFD_SET_DATA_PROPS(36,1,1,0,"Pu31in");
          _SFD_SET_DATA_PROPS(37,1,1,0,"Pu32in");
          _SFD_SET_DATA_PROPS(38,1,1,0,"Pu33in");
          _SFD_SET_DATA_PROPS(39,1,1,0,"ESRin");
          _SFD_SET_DATA_PROPS(40,1,1,0,"t0in");
          ...
          _SFD_SET_DATA_PROPS(45,2,0,1,"Pi11");
          _SFD_SET_DATA_PROPS(46,2,0,1,"Pi12");
          _SFD_SET_DATA_PROPS(47,2,0,1,"Pi21");
          _SFD_SET_DATA_PROPS(48,2,0,1,"Pi22");
          _SFD_SET_DATA_PROPS(49,2,0,1,"yu");
          _SFD_SET_DATA_PROPS(50,2,0,1,"eu");
          _SFD_SET_DATA_PROPS(51,2,0,1,"wu0");
          _SFD_SET_DATA_PROPS(52,2,0,1,"wu1");
          _SFD_SET_DATA_PROPS(53,2,0,1,"wu2");
          _SFD_SET_DATA_PROPS(54,2,0,1,"Pu11");
          _SFD_SET_DATA_PROPS(55,2,0,1,"Pu12");
          _SFD_SET_DATA_PROPS(56,2,0,1,"Pu13");
          _SFD_SET_DATA_PROPS(57,2,0,1,"Pu21");
          _SFD_SET_DATA_PROPS(58,2,0,1,"Pu22");
          _SFD_SET_DATA_PROPS(59,2,0,1,"Pu23");
          _SFD_SET_DATA_PROPS(60,2,0,1,"Pu31");
          _SFD_SET_DATA_PROPS(61,2,0,1,"Pu32");
          _SFD_SET_DATA_PROPS(62,2,0,1,"Pu33");
          _SFD_SET_DATA_PROPS(63,2,0,1,"ESRout");
          _SFD_SET_DATA_PROPS(64,2,0,1,"t0");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,6235);
        _SFD_CV_INIT_EML_IF(0,1,0,3283,3295,-1,6234);
        _SFD_CV_INIT_EML_IF(0,1,1,3376,3433,-1,4179);
        _SFD_CV_INIT_EML_IF(0,1,2,3474,3530,3559,4171);
        _SFD_CV_INIT_EML_IF(0,1,3,4184,4248,-1,4305);
        _SFD_CV_INIT_EML_IF(0,1,4,4467,4526,-1,5926);
        _SFD_CV_INIT_EML_IF(0,1,5,4570,4639,4668,5918);
        _SFD_CV_INIT_EML_IF(0,1,6,5931,5987,-1,6153);

        {
          static int condStart[] = { 3379, 3406 };

          static int condEnd[] = { 3402, 3432 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,3379,3432,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3477, 3504 };

          static int condEnd[] = { 3500, 3529 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,3477,3529,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4187, 4218 };

          static int condEnd[] = { 4214, 4247 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,4187,4247,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4470, 4503 };

          static int condEnd[] = { 4499, 4525 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,4470,4525,2,6,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 4573, 4606 };

          static int condEnd[] = { 4602, 4638 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,4,4573,4638,2,8,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 5934, 5961 };

          static int condEnd[] = { 5957, 5986 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,5,5934,5986,2,10,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(3U, c1_v_out);
          _SFD_SET_DATA_VALUE_PTR(4U, c1_i_in);
          _SFD_SET_DATA_VALUE_PTR(5U, c1_w0in);
          _SFD_SET_DATA_VALUE_PTR(6U, c1_w1in);
          _SFD_SET_DATA_VALUE_PTR(7U, c1_P11in);
          _SFD_SET_DATA_VALUE_PTR(8U, c1_P12in);
          _SFD_SET_DATA_VALUE_PTR(9U, c1_P21in);
          _SFD_SET_DATA_VALUE_PTR(10U, c1_P22in);
          _SFD_SET_DATA_VALUE_PTR(11U, c1_Capin);
          _SFD_SET_DATA_VALUE_PTR(12U, c1_y);
          _SFD_SET_DATA_VALUE_PTR(13U, c1_e);
          _SFD_SET_DATA_VALUE_PTR(14U, c1_w0);
          _SFD_SET_DATA_VALUE_PTR(15U, c1_w1);
          _SFD_SET_DATA_VALUE_PTR(16U, c1_P11);
          _SFD_SET_DATA_VALUE_PTR(17U, c1_P12);
          _SFD_SET_DATA_VALUE_PTR(18U, c1_P21);
          _SFD_SET_DATA_VALUE_PTR(19U, c1_P22);
          _SFD_SET_DATA_VALUE_PTR(20U, c1_Capout);
          _SFD_SET_DATA_VALUE_PTR(21U, c1_wi0in);
          _SFD_SET_DATA_VALUE_PTR(22U, c1_wi1in);
          _SFD_SET_DATA_VALUE_PTR(23U, c1_Pi11in);
          _SFD_SET_DATA_VALUE_PTR(24U, c1_Pi12in);
          _SFD_SET_DATA_VALUE_PTR(25U, c1_Pi21in);
          _SFD_SET_DATA_VALUE_PTR(26U, c1_Pi22in);
          _SFD_SET_DATA_VALUE_PTR(27U, c1_wu0in);
          _SFD_SET_DATA_VALUE_PTR(28U, c1_wu1in);
          _SFD_SET_DATA_VALUE_PTR(29U, c1_wu2in);
          _SFD_SET_DATA_VALUE_PTR(30U, c1_Pu11in);
          _SFD_SET_DATA_VALUE_PTR(31U, c1_Pu12in);
          _SFD_SET_DATA_VALUE_PTR(32U, c1_Pu13in);
          _SFD_SET_DATA_VALUE_PTR(33U, c1_Pu21in);
          _SFD_SET_DATA_VALUE_PTR(34U, c1_Pu22in);
          _SFD_SET_DATA_VALUE_PTR(35U, c1_Pu23in);
          _SFD_SET_DATA_VALUE_PTR(36U, c1_Pu31in);
          _SFD_SET_DATA_VALUE_PTR(37U, c1_Pu32in);
          _SFD_SET_DATA_VALUE_PTR(38U, c1_Pu33in);
          _SFD_SET_DATA_VALUE_PTR(39U, c1_ESRin);
          _SFD_SET_DATA_VALUE_PTR(40U, c1_t0in);
          _SFD_SET_DATA_VALUE_PTR(41U, c1_yi);
          _SFD_SET_DATA_VALUE_PTR(42U, c1_ei);
          _SFD_SET_DATA_VALUE_PTR(43U, c1_wi0);
          _SFD_SET_DATA_VALUE_PTR(44U, c1_wi1);
          _SFD_SET_DATA_VALUE_PTR(45U, c1_Pi11);
          _SFD_SET_DATA_VALUE_PTR(46U, c1_Pi12);
          _SFD_SET_DATA_VALUE_PTR(47U, c1_Pi21);
          _SFD_SET_DATA_VALUE_PTR(48U, c1_Pi22);
          _SFD_SET_DATA_VALUE_PTR(49U, c1_yu);
          _SFD_SET_DATA_VALUE_PTR(50U, c1_eu);
          _SFD_SET_DATA_VALUE_PTR(51U, c1_wu0);
          _SFD_SET_DATA_VALUE_PTR(52U, c1_wu1);
          _SFD_SET_DATA_VALUE_PTR(53U, c1_wu2);
          _SFD_SET_DATA_VALUE_PTR(54U, c1_Pu11);
          _SFD_SET_DATA_VALUE_PTR(55U, c1_Pu12);
          _SFD_SET_DATA_VALUE_PTR(56U, c1_Pu13);
          _SFD_SET_DATA_VALUE_PTR(57U, c1_Pu21);
          _SFD_SET_DATA_VALUE_PTR(58U, c1_Pu22);
          _SFD_SET_DATA_VALUE_PTR(59U, c1_Pu23);
          _SFD_SET_DATA_VALUE_PTR(60U, c1_Pu31);
          _SFD_SET_DATA_VALUE_PTR(61U, c1_Pu32);
          _SFD_SET_DATA_VALUE_PTR(62U, c1_Pu33);
          _SFD_SET_DATA_VALUE_PTR(63U, c1_ESRout);
          _SFD_SET_DATA_VALUE_PTR(64U, c1_t0);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c1_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2659217919U));
  ssSetChecksum1(S,(1427992471U));
  ssSetChecksum2(S,(2428388432U));
  ssSetChecksum3(S,(1569528792U));
