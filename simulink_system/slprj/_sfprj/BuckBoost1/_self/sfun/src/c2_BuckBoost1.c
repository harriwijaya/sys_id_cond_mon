...
static const char * c2_debug_family_names[29] = { "Err1", "Tsimulation",
  "Fix10us", "nargin", "nargout", "SS_Start", "Carrier", "Duty", "Vc", "IL",
  "Vo_Onk1", "Slope_Vo_Onk1", "IL_Onk1", "Slope_IL_Onk1", "Vo_Offk1",
  "Slope_Vo_Offk1", "IL_Offk1", "Slope_IL_Offk1", "Est_C_in", "Vo_On",
  "Slope_Vo_On", "IL_On", "Slope_IL_On", "Vo_Off", "Slope_Vo_Off", "IL_Off",
  "Slope_IL_Off", "Read", "Est_C" };
...
static real_T c2_emlrt_marshallIn(SFc2_BuckBoost1InstanceStruct *chartInstance,
  const mxArray *c2_Est_C, const char_T *c2_identifier);
  ...
  chartInstance)
{
  ...
  real_T *c2_Vo_Off;
  real_T *c2_Vo_On;
  c2_Est_C = (real_T *)ssGetOutputPortSignal(chartInstance->S, 10);
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_Est_C = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "Est_C");
  ...
  *c2_Slope_IL_Off = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 4)), "Slope_IL_Off");
  ...
  *c2_Slope_Vo_Off = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 6)), "Slope_Vo_Off");
...
static void sf_c2_BuckBoost1(SFc2_BuckBoost1InstanceStruct *chartInstance)
{
  ...
  real_T *c2_Est_C;
  real_T *c2_Est_C_in;
  c2_Est_C_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c2_Est_C = (real_T *)ssGetOutputPortSignal(chartInstance->S, 10);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_Est_C, 22U);
  _SFD_DATA_RANGE_CHECK(*c2_Est_C_in, 23U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  ...
  *chartInstance)
{
  ...
  c2_b_Est_C_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  c2_b_Est_C = (real_T *)ssGetOutputPortSignal(chartInstance->S, 10);
  ...
  c2_n_hoistedGlobal = *c2_b_Est_C_in;
  ...
  c2_Est_C_in = c2_n_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml(&c2_Est_C_in, 18U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_Vo_On, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Slope_Vo_On, 20U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_IL_On, 21U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Slope_IL_On, 22U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Vo_Off, 23U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Slope_Vo_Off, 24U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_IL_Off, 25U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Slope_IL_Off, 26U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Read, 27U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_Est_C, 28U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  const mxArray *c2_Est_C, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Est_C), &c2_thisId);
  sf_mex_destroy(&c2_Est_C);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_Est_C;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_BuckBoost1InstanceStruct *chartInstance;
  chartInstance = (SFc2_BuckBoost1InstanceStruct *)chartInstanceVoid;
  c2_Est_C = sf_mex_dup(c2_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1994571395U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2437522099U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1700009691U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3219542487U);
}
...
mxArray *sf_c2_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fghPsDLFPZQNGxlB0WLuqF");
...
static const mxArray *sf_get_sim_state_info_c2_BuckBoost1(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[50],T\"Est_C\",},{M[1],M[46],T\"IL_Off\",},{M[1],M[44],T\"IL_On\",},{M[1],M[34],T\"Read\",},{M[1],M[47],T\"Slope_IL_Off\",},{M[1],M[45],T\"Slope_IL_On\",},{M[1],M[31],T\"Slope_Vo_Off\",},{M[1],M[29],T\"Slope_Vo_On\",},{M[1],M[35],T\"Vo_Off\",},{M[1],M[28],T\"Vo_On\",}}",
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_BuckBoost1\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(22,2,0,1,"Est_C");
          _SFD_SET_DATA_PROPS(23,1,1,0,"Est_C_in");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2328);
        _SFD_CV_INIT_EML_IF(0,1,0,452,467,2181,2323);
        _SFD_CV_INIT_EML_IF(0,1,1,472,497,793,2180);
        _SFD_CV_INIT_EML_IF(0,1,2,793,822,1183,2180);
        _SFD_CV_INIT_EML_IF(0,1,3,1183,1202,1472,2180);
        _SFD_CV_INIT_EML_IF(0,1,4,1472,1491,1940,2180);

        {
          static int condStart[] = { 475, 488 };

          static int condEnd[] = { 484, 496 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,474,497,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 801, 813 };

          static int condEnd[] = { 809, 820 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,800,821,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(22U, c2_Est_C);
          _SFD_SET_DATA_VALUE_PTR(23U, c2_Est_C_in);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(9626415U));
  ssSetChecksum1(S,(3944149395U));
  ssSetChecksum2(S,(3938463463U));
  ssSetChecksum3(S,(4098801244U));
