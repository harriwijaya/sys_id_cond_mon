...
void InitSysCtrl(void)
{
   ...
   InitPll(DSP28_PLLCR,DSP28_DIVSEL); //Set to 150MHz by #Pre-defined DSP28_PLLCR=10 and DSP28_DIVSEL=2
...
////   SysCtrlRegs.PCLKCR1.bit.ECAP1ENCLK = 1;  // eCAP1
   SysCtrlRegs.PCLKCR1.bit.ECAP1ENCLK = 0;  //Debug to Disable eCAP1
