...
static const char * c4_debug_family_names[7] = { "nargin", "nargout", "ESRin",
  "ESRavrgIn", "CntIn", "ESRavrg", "Cnt" };
...
static real_T c4_emlrt_marshallIn(SFc4_BuckBoost1InstanceStruct *chartInstance,
  const mxArray *c4_Cnt, const char_T *c4_identifier);
  ...
  chartInstance)
{
  ...
  real_T *c4_Cnt;
  real_T *c4_ESRavrg;
  c4_Cnt = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c4_ESRavrg = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellarray(3), FALSE);
  c4_hoistedGlobal = *c4_Cnt;
  c4_u = c4_hoistedGlobal;
  c4_b_y = NULL;
  sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c4_y, 0, c4_b_y);
  c4_b_hoistedGlobal = *c4_ESRavrg;
  c4_b_u = c4_b_hoistedGlobal;
  c4_c_y = NULL;
  sf_mex_assign(&c4_c_y, sf_mex_create("y", &c4_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c4_y, 1, c4_c_y);
  c4_c_hoistedGlobal = chartInstance->c4_is_active_c4_BuckBoost1;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_Cnt = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
    "Cnt");
  *c4_ESRavrg = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "ESRavrg");
...
static void sf_c4_BuckBoost1(SFc4_BuckBoost1InstanceStruct *chartInstance)
{
  ...
  real_T *c4_b_ESRavrg;
  real_T *c4_b_CntIn;
  real_T *c4_b_ESRavrgIn;
  real_T *c4_b_ESRin;
  c4_b_Cnt = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c4_b_CntIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_ESRavrgIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_ESRavrg = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_ESRin = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_b_ESRin, 0U);
  _SFD_DATA_RANGE_CHECK(*c4_b_ESRavrg, 1U);
  _SFD_DATA_RANGE_CHECK(*c4_b_ESRavrgIn, 2U);
  _SFD_DATA_RANGE_CHECK(*c4_b_CntIn, 3U);
  _SFD_DATA_RANGE_CHECK(*c4_b_Cnt, 4U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_ESRin;
  c4_b_hoistedGlobal = *c4_b_ESRavrgIn;
  c4_c_hoistedGlobal = *c4_b_CntIn;
  c4_ESRin = c4_hoistedGlobal;
  c4_ESRavrgIn = c4_b_hoistedGlobal;
  c4_CntIn = c4_c_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c4_ESRin, 2U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_ESRavrgIn, 3U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c4_CntIn, 4U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_ESRavrg, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c4_Cnt, 6U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 4);
  c4_Cnt = c4_CntIn + 1.0;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 15);
  if (CV_EML_IF(0, 1, 0, c4_Cnt < 6400.0)) {
    ...
    c4_d_x = c4_c_x;
    c4_f_y = c4_e_y;
    c4_g_y = c4_d_x / c4_f_y;
    c4_ESRavrg = c4_d_y + c4_g_y;
  } else {
    ...
    c4_f_x = c4_e_x;
    c4_i_y = c4_h_y;
    c4_j_y = c4_f_x / c4_i_y;
    c4_b_a = c4_j_y;
    c4_b_b = c4_ESRavrgIn;
    c4_k_y = c4_b_a * c4_b_b;
    c4_d_A = c4_ESRin;
    c4_d_B = c4_Cnt;
    c4_g_x = c4_d_A;
    c4_l_y = c4_d_B;
  ...
  const mxArray *c4_Cnt, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_Cnt), &c4_thisId);
  sf_mex_destroy(&c4_Cnt);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_Cnt;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_BuckBoost1InstanceStruct *chartInstance;
  chartInstance = (SFc4_BuckBoost1InstanceStruct *)chartInstanceVoid;
  c4_Cnt = sf_mex_dup(c4_mxArrayInData);
...
const mxArray *sf_c4_BuckBoost1_get_eml_resolved_functions_info(void)
{
  ...
  (*c4_b_info)[1].fileTimeLo = 1342789344U;
  ...
  (*c4_b_info)[2].fileTimeLo = 1286797244U;
  ...
  (*c4_b_info)[3].fileTimeLo = 1313326210U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4235347424U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4074762083U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3166079643U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3115766715U);
}
...
mxArray *sf_c4_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("znsp9Fss62ScWjwFJvap9C");
...
static const mxArray *sf_get_sim_state_info_c4_BuckBoost1(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"Cnt\",},{M[1],M[5],T\"ESRavrg\",},{M[8],M[0],T\"is_active_c4_BuckBoost1\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(_BuckBoost1MachineNumber_,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"ESRin");
          _SFD_SET_DATA_PROPS(1,2,0,1,"ESRavrg");
          _SFD_SET_DATA_PROPS(2,1,1,0,"ESRavrgIn");
          _SFD_SET_DATA_PROPS(3,1,1,0,"CntIn");
          _SFD_SET_DATA_PROPS(4,2,0,1,"Cnt");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,284,301,371,539);
...

        {
          ...
          real_T *c4_Cnt;
          c4_Cnt = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c4_CntIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c4_ESRavrgIn = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c4_ESRavrg = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c4_ESRin = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_ESRin);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_ESRavrg);
          _SFD_SET_DATA_VALUE_PTR(2U, c4_ESRavrgIn);
          _SFD_SET_DATA_VALUE_PTR(3U, c4_CntIn);
          _SFD_SET_DATA_VALUE_PTR(4U, c4_Cnt);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c4_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1098966886U));
  ssSetChecksum1(S,(1405808506U));
  ssSetChecksum2(S,(3081699350U));
  ssSetChecksum3(S,(3100823964U));
