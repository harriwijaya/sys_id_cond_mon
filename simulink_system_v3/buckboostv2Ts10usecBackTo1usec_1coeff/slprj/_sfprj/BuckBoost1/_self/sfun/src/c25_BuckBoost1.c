...
static void sf_c25_BuckBoost1(SFc25_BuckBoost1InstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 6U, chartInstance->c25_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c25_b_Ts, 0U);
  _SFD_DATA_RANGE_CHECK(*c25_b_TimeCNT_k1, 1U);
  _SFD_DATA_RANGE_CHECK(*c25_b_TimeCNT_k, 2U);
  chartInstance->c25_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 6U, chartInstance->c25_sfEvent);
  ...
  *c25_b_TimeCNT_k = c25_TimeCNT_k;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 6U, chartInstance->c25_sfEvent);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3835439968U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(490454673U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(44596886U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2928326796U);
}
...
mxArray *sf_c25_BuckBoost1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ELwk6rnx2TAzcJ7p4atCV");
...
static void mdlSetWorkWidths_c25_BuckBoost1(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4024182556U));
  ssSetChecksum1(S,(1214747070U));
  ssSetChecksum2(S,(4268353638U));
  ssSetChecksum3(S,(1673958578U));
